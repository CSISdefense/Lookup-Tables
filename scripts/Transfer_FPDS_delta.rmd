...
### 1.3B) Have access to the SQL login and password.
...
read_and_join_experiment(filecheck,"ErrorLogging_FPDS_delta_sizetype.csv",dir

-   New unrecognized column

Update [ImportAids /
missing_fpds_delta_matches.csv](https://github.com/CSISdefense/Lookup-Tables/blob/master/ImportAids/ErrorLogging_FPDS_delta_sizetype.csv)
...
-   Import Aids "ErrorLogging_FPDS_delta_sizetype.csv"

-   In SQL Server in the "ErrorLogging"."FPDSdelta" table

``` sql
alter table errorlogging.fpdsdelta
