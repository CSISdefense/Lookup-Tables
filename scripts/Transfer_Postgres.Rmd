...
ctu_sql<-paste("select fiscal_year,",
                "contract_transaction_unique_key,",
                "csistransactionid,",
                "last_modified_date",
               "total_outlayed_amount_for_overall_award",
                "FROM contract.FPDS",
                "ORDER BY fiscal_year, contract_transaction_unique_key",
                collapse=" ")


sql_fpds<-dbGetQuery(con,  ctu_sql)
...
sql_fpds<-sql_fpds %>% filter(contract_transaction_unique_key!="NULL" &
                                !is.na(contract_transaction_unique_key))

save(sql_fpds,file=file.path("..","..","USAspending-local",paste("contract_fpds_ctu_list_",
                                                            gsub("-","_",as.character(Sys.Date())),".rda",
                                                       sep="")))
