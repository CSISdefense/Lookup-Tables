...
GO
ALTER TABLE [Contract].[FSRS] ADD  CONSTRAINT [DF__FSRS__CSIScreate__0A3F39D6]  DEFAULT (getdate()) FOR [CSIScreatedDate]
GO
ALTER TABLE [Contract].[FSRS]  WITH NOCHECK ADD  CONSTRAINT [fk_Contract_FSRS] FOREIGN KEY([PrimeAwardContractingAgencyID])
REFERENCES [FPDSTypeTable].[AgencyID] ([AgencyID])
GO
ALTER TABLE [Contract].[FSRS] CHECK CONSTRAINT [fk_Contract_FSRS]
GO
ALTER TABLE [Contract].[FSRS]  WITH NOCHECK ADD  CONSTRAINT [fk_Contract_FSRS_PrimeAwardPrincipalPlaceCountry] FOREIGN KEY([PrimeAwardPrincipalPlaceCountry])
...
GO
ALTER TABLE [Contract].[FSRS]  WITH NOCHECK ADD  CONSTRAINT [fk_Contract_FSRS_PrimeAwardReportID] FOREIGN KEY([PrimeAwardReportID])
...
GO
ALTER TABLE [Contract].[FSRS]  WITH NOCHECK ADD  CONSTRAINT [fk_FSRS_PrimeAwardeeParentDuns] FOREIGN KEY([PrimeAwardeeParentDuns])
REFERENCES [Contractor].[Dunsnumber] ([DUNSnumber])
GO
ALTER TABLE [Contract].[FSRS] CHECK CONSTRAINT [fk_FSRS_PrimeAwardeeParentDuns]
GO
ALTER TABLE [Contract].[FSRS]  WITH NOCHECK ADD  CONSTRAINT [fk_FSRS_SubawardeeCountrycode] FOREIGN KEY([SubawardeeCountrycode])
REFERENCES [FPDSTypeTable].[Country3LetterCode] ([Country3LetterCode])
GO
ALTER TABLE [Contract].[FSRS] CHECK CONSTRAINT [fk_FSRS_SubawardeeCountrycode]
GO
ALTER TABLE [Contract].[FSRS]  WITH NOCHECK ADD  CONSTRAINT [fk_FSRS_SubawardeeDunsnumber] FOREIGN KEY([SubawardeeDunsnumber])
REFERENCES [Contractor].[Dunsnumber] ([DUNSnumber])
GO
ALTER TABLE [Contract].[FSRS] CHECK CONSTRAINT [fk_FSRS_SubawardeeDunsnumber]
GO
ALTER TABLE [Contract].[FSRS]  WITH NOCHECK ADD  CONSTRAINT [fk_FSRS_SubawardeeParentDuns] FOREIGN KEY([SubawardeeParentDuns])
REFERENCES [Contractor].[Dunsnumber] ([DUNSnumber])
GO
ALTER TABLE [Contract].[FSRS] CHECK CONSTRAINT [fk_FSRS_SubawardeeParentDuns]
GO
ALTER TABLE [Contract].[FSRS]  WITH NOCHECK ADD  CONSTRAINT [fk_FSRS_SubawardPrincipalPlaceCountry] FOREIGN KEY([SubawardPrincipalPlaceCountry])
REFERENCES [FPDSTypeTable].[Country3LetterCode] ([Country3LetterCode])
GO
