...
GO
ALTER TABLE [ErrorLogging].[USAIDphoenixViolatesConstraint] ADD  CONSTRAINT [DF_Errorlogging__USAIDPhoenix_CSISmodifieddate]  DEFAULT (getdate()) FOR [CSISmodifiedDate]
GO
