...
GO
CREATE TABLE [ETL].[GSAprimeStage1](
...
GO
ALTER TABLE [ETL].[GSAprimeStage1] ADD  CONSTRAINT [DF_GSAprimecontract_CSISCreatedDate]  DEFAULT (getdate()) FOR [CSISCreatedDate]
GO
ALTER TABLE [ETL].[GSAprimeStage1] ADD  CONSTRAINT [DF_GSAprimecontract_CSISModifiedDate]  DEFAULT (getdate()) FOR [CSISModifiedDate]
GO
ALTER TABLE [ETL].[GSAprimeStage1] ADD  DEFAULT ((0)) FOR [IsDuplicateUTI]
GO
