/****** Object:  Table [ErrorLogging].[FPDSstage1]    Script Date: 4/25/2024 9:21:13 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [ErrorLogging].[FPDSdelta1](
...
ALTER TABLE [ErrorLogging].[FPDSdelta1] ADD  CONSTRAINT [DF__FPDSdeltaCSISmodifiedDate]  DEFAULT (getdate()) FOR [CSISmodifiedDate]
GO
