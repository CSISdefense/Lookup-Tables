...
GO
CREATE TABLE [ETL].[GSAprimeStage2](
...
GO
ALTER TABLE [ETL].[GSAprimeStage2] ADD  DEFAULT (getdate()) FOR [CSISmodifiedDate]
GO
ALTER TABLE [ETL].[GSAprimeStage2] ADD  DEFAULT (getdate()) FOR [CSIScreatedDate]
GO
ALTER TABLE [ETL].[GSAprimeStage2]  WITH CHECK ADD FOREIGN KEY([CSISserviceCensusID])
