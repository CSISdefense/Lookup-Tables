...
GO
CREATE TABLE [ETL].[FAADSviolatesConstraint](
...
GO
ALTER TABLE [ETL].[FAADSviolatesConstraint] ADD  CONSTRAINT [DF_ERRORLOGGING_FaadsViolatesConstraint_csiscreateddate]  DEFAULT (getdate()) FOR [CSISCreatedDate]
GO
ALTER TABLE [ETL].[FAADSviolatesConstraint] ADD  CONSTRAINT [DF_ERRORLOGGING_FaadsViolatesConstraint_CSISModifiedDate]  DEFAULT (getdate()) FOR [csismodifieddate]
GO
