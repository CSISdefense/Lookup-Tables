...
CREATE TABLE [ETL].[FPDSdelta](
	...
	[IsOutdatedDuplicate] [bit] NOT NULL
) ON [PRIMARY]
GO
SET ANSI_PADDING ON
GO
CREATE NONCLUSTERED INDEX [ix_ErrorLogging_FPDSdelta_contract_award_unique_key] ON [ETL].[FPDSdelta]
(
...
SET ANSI_PADDING ON
GO
CREATE UNIQUE NONCLUSTERED INDEX [ix_errorlogging_FPDSdelta_ctu_correction_delete_ind] ON [ETL].[FPDSdelta]
(
...
GO
ALTER TABLE [ETL].[FPDSdelta] ADD  CONSTRAINT [DF__FPDSdelta2CSISmodifiedDate]  DEFAULT (getdate()) FOR [CSISmodifiedDate]
GO
ALTER TABLE [ETL].[FPDSdelta] ADD  CONSTRAINT [DF__FPDSdelta2CSIScreatedDate]  DEFAULT (getdate()) FOR [CSIScreatedDate]
GO
ALTER TABLE [ETL].[FPDSdelta] ADD  DEFAULT ((0)) FOR [IsTransferred]
GO
ALTER TABLE [ETL].[FPDSdelta] ADD  DEFAULT ((0)) FOR [IsOutdatedDuplicate]
GO
ALTER TABLE [ETL].[FPDSdelta]  WITH CHECK ADD FOREIGN KEY([temp_uei])
