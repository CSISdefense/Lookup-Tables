...
CREATE TABLE [Assistance].[USAIDphoenixOLD](
	...
	[SOURCE_OF_APPN_SYMBOL] [float] NULL,
...
GO
ALTER TABLE [Assistance].[USAIDphoenixOLD] ADD  CONSTRAINT [DF_USAIDPhoenix_CSISmodifieddate]  DEFAULT (getdate()) FOR [CSISmodifiedDate]
GO
