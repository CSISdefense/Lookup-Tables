...
GO
CREATE TABLE [ErrorLogging].[FAADCstage1](
	...
	[action_date_fiscal_year] [int] NULL,
...
GO
ALTER TABLE [ErrorLogging].[FAADCstage1] ADD  CONSTRAINT [FAADCstage1_CSIScreatedDate_default]  DEFAULT (getdate()) FOR [CSIScreatedDate]
GO
