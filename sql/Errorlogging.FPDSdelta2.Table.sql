/****** Object:  Table [ErrorLogging].[FPDSstage2]    Script Date: 4/25/2024 9:18:57 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [ErrorLogging].[FPDSdelta2](
	...
	[lastdatetoorder] [datetime2](7) NULL,
	...
	[multiple_or_single_award_idv_name] [varchar](255) NULL,
	...
	[contract_bundling_name] [varchar](255) NULL,
	...
	[recovered_materials_sustainability_name] [varchar](255) NULL,
	[manufacturingorganizationtype] [varchar](1) NULL,
	[domestic_or_foreign_entity_name] [varchar](255) NULL,
	...
	[information_technology_commercial_item_category_name] [varchar](255) NULL,
	[useofepadesignatedproducts] [varchar](1) NULL,
	[epa_designated_product_name] [varchar](255) NULL,
	[countryoforigin] [varchar](3) NULL,
	[country_of_product_or_service_origin_name] [varchar](255) NULL,
	[placeofmanufacture] [varchar](1) NULL,
	[place_of_manufacture_name] [varchar](255) NULL,
	[subcontractplan] [varchar](1) NULL,
	[subcontracting_plan_name] [varchar](255) NULL,
	[extentcompeted] [varchar](3) NULL,
	[extent_competed_name] [varchar](255) NULL,
	[solicitationprocedures] [varchar](5) NULL,
	[solicitation_procedures_name] [varchar](255) NULL,
	[typeofsetaside] [varchar](10) NULL,
	[type_of_set_aside_name] [varchar](255) NULL,
	[evaluatedpreference] [varchar](6) NULL,
	[evaluated_preference_name] [varchar](255) NULL,
	...
	[other_than_full_and_open_competition_name] [varchar](255) NULL,
	...
	[clinger_cohen_act_planning_name] [varchar](255) NULL,
	[walshhealyact] [varchar](1) NULL,
	[walsh_healey_act_name] [varchar](255) NULL,
	[servicecontractact] [varchar](1) NULL,
	[service_contract_act_name] [varchar](255) NULL,
	[davisbaconact] [varchar](1) NULL,
	[davis_bacon_act_name] [varchar](255) NULL,
	[interagencycontractingauthority] [varchar](3) NULL,
	[interagency_contracting_authority_name] [varchar](255) NULL,
	[otherstatutoryauthority] [varchar](1000) NULL,
	[programacronym] [varchar](29) NULL,
	[parent_award_type_code] [varchar](1) NULL,
	[parent_award_type_name] [varchar](255) NULL,
	[parent_award_single_or_multiple_code] [varchar](1) NULL,
	[parent_award_single_or_multiple_name] [varchar](255) NULL,
	[majorprogramcode] [varchar](104) NULL,
	[nationalinterestactioncode] [varchar](4) NULL,
	[national_interest_action_name] [varchar](255) NULL,
	[costorpricingdata] [varchar](1) NULL,
	[cost_or_pricing_data_name] [varchar](255) NULL,
	...
	[sea_transportation_name] [varchar](255) NULL,
	...
	[multi_year_contract_name] [varchar](255) NULL,
	[contractfinancing] [varchar](1) NULL,
	[contract_financing_name] [varchar](255) NULL,
	[purchasecardaspaymentmethod] [bit] NULL,
	[purchase_card_as_payment_method_name] [varchar](255) NULL,
	[contingencyhumanitarianpeacekeepingoperation] [varchar](1) NULL,
	[contingency_humanitarian_or_peacekeeping_operation_name] [varchar](255) NULL,
	...
	agency_id varchar(4),
	correction_delete_ind varchar(1)
) ON [PRIMARY]
GO

ALTER TABLE [ErrorLogging].[FPDSdelta2] ADD  CONSTRAINT [DF__FPDSdelta2__CSISm__7193879D]  DEFAULT (getdate()) FOR [CSISmodifiedDate]
GO

ALTER TABLE [ErrorLogging].[FPDSdelta2] ADD  CONSTRAINT [DF__FPDSdelta2__CSISc__7287ABD6]  DEFAULT (getdate()) FOR [CSIScreatedDate]
GO

ALTER TABLE [ErrorLogging].[FPDSdelta2]  WITH CHECK ADD FOREIGN KEY([CSIStransactionID])
