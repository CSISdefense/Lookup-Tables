/****** Object:  Table [ErrorLogging].[FPDSdelta]    Script Date: 5/4/2024 8:25:35 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [ErrorLogging].[FPDSdelta] ADD  CONSTRAINT [DF__FPDSdeltaCSISmodifiedDate]  DEFAULT (getdate()) FOR [CSISmodifiedDate]
GO

ALTER TABLE [ErrorLogging].[FPDSdelta] ADD  CONSTRAINT [DF__FPDSdeltaCSIScreatedDate]  DEFAULT (getdate()) FOR [CSIScreatedDate]
GO
