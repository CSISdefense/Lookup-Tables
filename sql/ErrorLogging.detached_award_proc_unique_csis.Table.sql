...
GO
CREATE TABLE [ErrorLogging].[detached_award_proc_unique_csis](
...
GO
ALTER TABLE [ErrorLogging].[detached_award_proc_unique_csis]  WITH CHECK ADD  CONSTRAINT [fk_ErrorLogging_detached_award_proc_unique_CSIStransactionid] FOREIGN KEY([CSIStransactionid])
REFERENCES [Contract].[CSIStransactionID] ([CSIStransactionID])
GO
ALTER TABLE [ErrorLogging].[detached_award_proc_unique_csis] CHECK CONSTRAINT [fk_ErrorLogging_detached_award_proc_unique_CSIStransactionid]
GO
