...
GO
CREATE TABLE [ETL].[FPDSdeltaOutdatedDuplicate](
...
GO
ALTER TABLE [ETL].[FPDSdeltaOutdatedDuplicate] ADD  CONSTRAINT [DF__FPDSdelta2OutdatedDuplicateCSISmodifiedDate]  DEFAULT (getdate()) FOR [CSISmodifiedDate]
GO
ALTER TABLE [ETL].[FPDSdeltaOutdatedDuplicate] ADD  CONSTRAINT [DF__FPDSdelta2CSISDupliatecreatedDate]  DEFAULT (getdate()) FOR [CSIScreatedDate]
GO
ALTER TABLE [ETL].[FPDSdeltaOutdatedDuplicate] ADD  DEFAULT ((0)) FOR [IsTransferred]
GO
