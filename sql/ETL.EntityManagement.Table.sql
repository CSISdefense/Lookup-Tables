...
GO
CREATE TABLE [ETL].[EntityManagement](
...
GO
ALTER TABLE [ETL].[EntityManagement] ADD  CONSTRAINT [DF_SAM_CSISCreatedDate]  DEFAULT (getdate()) FOR [CSISCreatedDate]
GO
ALTER TABLE [ETL].[EntityManagement] ADD  CONSTRAINT [DF_SAM_CSISModifiedDate]  DEFAULT (getdate()) FOR [CSISModifiedDate]
GO
