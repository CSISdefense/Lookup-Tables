...
GO
ALTER TABLE [ErrorLogging].[FPDSduplicates] CHECK CONSTRAINT [fk_ErrorLogging_FPDSduplicates]
GO
ALTER TABLE [ErrorLogging].[FPDSduplicates]  WITH CHECK ADD  CONSTRAINT [fk_errorlogging_FPDSduplicates_CSIStransactionID] FOREIGN KEY([CSIStransactionID])
REFERENCES [Contract].[CSIStransactionID] ([CSIStransactionID])
GO
ALTER TABLE [ErrorLogging].[FPDSduplicates] CHECK CONSTRAINT [fk_errorlogging_FPDSduplicates_CSIStransactionID]
GO
