...
GO
CREATE TABLE [ETL].[FSRSviolatesConstraint](
	...
	[PrimeAwardPrincipalPlaceCountry] [varchar](7) NULL,
...
GO
ALTER TABLE [ETL].[FSRSviolatesConstraint] ADD  CONSTRAINT [DF__FSRSviola__CSISc__0762CD2B]  DEFAULT (getdate()) FOR [CSIScreatedDate]
GO
ALTER TABLE [ETL].[FSRSviolatesConstraint] ADD  CONSTRAINT [DF__FSRSviola__CSISm__0856F164]  DEFAULT (getdate()) FOR [CSISmodifiedDate]
GO
