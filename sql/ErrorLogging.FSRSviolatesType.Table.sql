...
GO
ALTER TABLE [ErrorLogging].[FSRSviolatesType] ADD  CONSTRAINT [DF__FSRSviola__CSISc__01A9F3D5]  DEFAULT (getdate()) FOR [CSIScreatedDate]
GO
ALTER TABLE [ErrorLogging].[FSRSviolatesType] ADD  CONSTRAINT [DF__FSRSviola__CSISm__029E180E]  DEFAULT (getdate()) FOR [CSISmodifiedDate]
GO
